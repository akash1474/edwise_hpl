  ...
  return (
    <div className="bg-white px-6 my-20">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg leading-8 text-gray-600">We're here to assist you. Whether you have questions about registrations, events, or general inquiries, our team is ready to help. Reach out to us for prompt assistance.</p>
      </div>
