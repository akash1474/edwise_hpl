...
const Payment=async()=>{
  ...
  // console.log(session.user);
	...
	return (
	<div className="h-[calc(100vh-100px)] min-h-[600px] w-full flex items-center justify-center">
		<form className=" relative flex w-[400px] flex-col items-start justify-center py-10 px-5 max-sm:shadow-none shadow-xl shadow-slate-600">
