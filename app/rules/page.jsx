...
const RulesPage=async()=>{
	...
	return (
		<div className="flex flex-col items-center">
			<section className="w-4/5 border border-slate-200 max-sm:w-[calc(100%-50px)] py-7 px-5 mt-10 mb-0">
				...
				<ul className="space-y-1 text-gray-500 list-disc ml-5">
					...
					<li><span className={highlight}>Engage in an intense 8 </span> - over battle, where every ball counts towards victory.</li>
			...
			<section className="w-4/5 max-sm:w-[calc(100%-50px)] py-7 px-5 mt-5 mb-10 flex flex-col items-center">
				...
				<Link href="/login">
					<button className="btn_black rounded-sm font-medium">Accept & Continue</button>
				</Link>
			</section>
		</div>
	);
